...
/**
 * Source: https://github.com/vercel/next.js/blob/f6998e30a815e976173501a62e6e481f92699d81/packages/next/src/build/babel/preset.ts
 */
...
export type NextBabelPresetOptions = {
  'preset-env'?: any;
  'preset-react'?: any;
...
export default (api: any, options: NextBabelPresetOptions = {}): BabelPreset => {
  ...
  if (
    (isServer || isTest) &&
    (!presetEnvironmentConfig.targets ||
      !(
        typeof presetEnvironmentConfig.targets === 'object' &&
        'node' in presetEnvironmentConfig.targets
      ))
  ) {
    presetEnvironmentConfig.targets = {
  ...
  return {
    ...
    presets: [
      [require('@babel/preset-env'), presetEnvironmentConfig],
      [
    ...
    plugins: [
      ...
      !isServer && [
        require('@babel/plugin-transform-runtime'),
        {
          ...
          helpers: true,
          regenerator: true,
          useESModules: supportsESM && presetEnvironmentConfig.modules !== 'commonjs',
