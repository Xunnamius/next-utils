...
/**
 * Source: https://github.com/vercel/next.js/blob/f6998e30a815e976173501a62e6e481f92699d81/packages/next/src/build/babel/plugins/react-loadable-plugin.ts
 */
  ...
  return {
    visitor: {
      ImportDeclaration(path: NodePath<BabelTypes.ImportDeclaration>, state: any) {
        ...
        binding.referencePaths.forEach((referencePath: any) => {
          let callExpression = referencePath.parentPath;
