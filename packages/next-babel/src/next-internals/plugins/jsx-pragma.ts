...
/**
 * Source: https://github.com/vercel/next.js/blob/f6998e30a815e976173501a62e6e481f92699d81/packages/next/src/build/babel/plugins/jsx-pragma.ts
 */
        ...
        exit(path: NodePath<BabelTypes.Program>, state) {
          if (state.get('jsx')) {
            ...
            if (state.opts.property) {
              importAs = state.opts.importAs
                ? t.identifier(state.opts.importAs)
                : path.scope.generateUidIdentifier('pragma');
